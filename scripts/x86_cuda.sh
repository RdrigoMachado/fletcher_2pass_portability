...
# --- Configurações x86 ---
ARCH="89" # Ada Lovelace (RTX 4090)
BIN_DIR="../binaries/nvidia_x86"
BUILD_DIR="build_x86"

# Define caminhos das bibliotecas (ajuste se necessário para seu container x86)
...
echo "=========================================================="
echo "   Iniciando Compilação Total - NVIDIA x86 (RTX 4090)"
echo "=========================================================="
...
# 5. HIP (Rodando sobre NVIDIA)
# Requer imagem com hip-runtime-nvidia instalado
echo -e "\n>> [5/5] Compilando HIP (sobre NVIDIA)..."
rm -rf $BUILD_DIR/* && cd $BUILD_DIR
...
echo "----------------------------------------------------------"
echo "✅ Todos os binários x86 gerados em: $BIN_DIR"
ls -lh $BIN_DIR
